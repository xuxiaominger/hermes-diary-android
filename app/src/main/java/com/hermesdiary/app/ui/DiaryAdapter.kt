...
import com.hermesdiary.app.databinding.ItemDiaryCardBinding
...
class DiaryAdapter(
...
) : ListAdapter<DiaryEntry, DiaryAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(private val binding: ItemDiaryCardBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(entry: DiaryEntry) {
            binding.titleText.text = entry.title.ifEmpty { "无标题" }
