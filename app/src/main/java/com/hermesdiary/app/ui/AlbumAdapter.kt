...
import com.hermesdiary.app.databinding.ItemAlbumCardBinding
...
class AlbumAdapter(
...
) : ListAdapter<DiaryEntry, AlbumAdapter.ViewHolder>(DiffCallback()) {
    ...
    inner class ViewHolder(private val binding: ItemAlbumCardBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(entry: DiaryEntry) {
            binding.titleText.text = entry.title.ifEmpty { "无标题图册" }
